...
graph_rules <- function(df, target, cut_off, resistance_indicator, measures_used, data_source, rules_selected, agg = FALSE, save_legend = TRUE){
    ...
    for (year in available_years){
        ...
        # Open a PNG device
        png(filename = str_glue("dataset_specific_outputs/{data_source}/figures/network_graphs/{resistance_indicator}/{rules_selected}/agg{agg}/{data_source}_{resistance_indicator}_{target}_network_{year}_agg{agg}.png"), 
