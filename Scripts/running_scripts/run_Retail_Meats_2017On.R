...
#get the data ready
Retail_Meats_2017Onward_phenotype_df <- read.csv("dataset_specific_outputs/Retail_Meats_2017Onward/NEW_Retail_Meats_2017Onward_wide_resStatus_phenotype.csv")
Retail_Meats_2017Onward_Class_level_phenotype_df <- read.csv("dataset_specific_outputs/Retail_Meats_2017Onward/NEW_Retail_Meats_2017Onward_wide_class_level_phenotype.csv")

Retail_Meats_2017Onward_Family_genotype_df <- read.csv("dataset_specific_outputs/Retail_Meats_2017Onward/Retail_Meats_2017Onward_wide_corrected_genotype.csv")
Retail_Meats_2017Onward_Family_genotype_df <- read.csv("dataset_specific_outputs/Retail_Meats_2017Onward/Retail_Meats_2017Onward_wide_family_level_genotype.csv")
Retail_Meats_2017Onward_Class_level_genotype_df <- read.csv("dataset_specific_outputs/Retail_Meats_2017Onward/Retail_Meats_2017Onward_wide_class_level_genotype.csv")
...
# NETWORK GRAPHS WERE NOT USED IN THE PAPER
...
print("DONE RUNNING THE RETAIL MEATS 2017 ONWARD ANALYSIS")