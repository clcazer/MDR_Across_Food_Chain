...
source(here("Scripts", "function_scripts", "data_wrangling_Retail.R"))


#RUN THE DATA WRANGLING FOR THE PHENOTYPE
Retail_Meats_df <- read.csv("Raw_Data/Retail_Meats_Data/CVM-NARMS-Retail-Meats.csv")
...
ID_Year_lookup_df <- read.csv("Raw_Data/Retail_Meats_Data/CVM-NARMS-Retail-Meats.csv")
