...
source(here("Scripts", "function_scripts", "data_wrangling_NAHLN.R"))
source(here("Scripts", "function_scripts", "data_wrangling.R"))

#RUN THE DATA WRANGLING FOR THE PHENOTYPE
df <- read_excel("Raw_Data/NAHLN_Data/NAHLN_CattleEcoli_PPY1-PPY5_10-12-2023.xlsx")
...
ID_lookup_df <- read_excel("Raw_Data/NAHLN_Data/Isolate+BioSample.xlsx")
Year_lookup_df <- read.csv("Raw_Data/NAHLN_Data/NAHLN_CattleEcoli_PPY1-PPY5_10-12-2023.csv")
...
print("DONE WITH NAHLN DATA WRANGLING")
