...
#get the data ready
cecal_2017Onward_phenotype_df <- read.csv("cecal_2017Onward/cecal_2017Onward_wide_resStatus_phenotype.csv")
cecal_2017Onward_Class_level_phenotype_df <- read.csv("cecal_2017Onward/cecal_2017Onward_wide_class_level_phenotype.csv")
