...
#get the data ready
cecal_2017Onward_phenotype_df <- read.csv("cecal_2017Onward/NEW_cecal_2017Onward_wide_resStatus_phenotype.csv")
cecal_2017Onward_Class_level_phenotype_df <- read.csv("cecal_2017Onward/NEW_cecal_2017Onward_wide_class_level_phenotype.csv")



cecal_2017Onward_genotype_df <- read.csv("cecal_2017Onward/cecal_2017Onward_wide_corrected_genotype.csv")
cecal_2017Onward_Family_genotype_df <- read.csv("cecal_2017Onward/cecal_2017Onward_wide_family_level_genotype.csv")
cecal_2017Onward_Class_level_genotype_df <- read.csv("cecal_2017Onward/cecal_2017Onward_wide_class_level_genotype.csv")
